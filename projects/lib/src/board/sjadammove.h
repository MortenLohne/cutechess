 ...
 */
  ...
  inline SjadamMove::SjadamMove()
    : Move()
  {
  }

  inline SjadamMove::SjadamMove(int sourceSquare,
		    int targetSquare,
		    int sjadamSquare,
		    int promotion)
    : Move(sourceSquare,
  ...
  inline SjadamMove::SjadamMove(Move mv)
    : Move(mv.sourceSquare(), mv.targetSquare(), mv.promotion())
    
      {
	m_sjadamSquare = mv.sourceSquare();
      };
...
Q_DECLARE_METATYPE(Chess::SjadamMove)
